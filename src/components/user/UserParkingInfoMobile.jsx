      ...
      <main style={styles.main}>
        ...
        {!vehicleData && (
          <div style={styles.heroSection}>
            ...
            <p style={styles.heroSub}>
              Enter your plate to check your parking status and proceed to checkout.
            </p>
          </div>
        )}
        ...
        {error && (
          <div style={styles.errorBox}>
            <span
              className="material-symbols-outlined"
              style={{ verticalAlign: 'middle', marginRight: '6px', fontSize: '16px' }}
            >
              error
            </span>
            {error}
          ...
          <>
              ...
              <div style={styles.rightCard}>
                ...
                {vehicleData.status === 'Exited' && (
                  <div style={styles.rightCardFoot}>
                    <span
                      className="material-symbols-outlined"
                      style={{ color: '#f9d006', fontSize: '20px' }}
                    >
                      directions_car
                    </span>
                    <div>
                      <p style={{ fontSize: '13px', fontWeight: 600, marginBottom: '2px' }}>
                        Vehicle has exited the premises
                      </p>
                      <p style={{ fontSize: '12px', color: '#475569' }}>
                        Please proceed to pay via UPI QR code
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div style={styles.checkoutBar}>
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <p style={styles.checkoutSub}>
                    Scan the QR code at the gate — no paper ticket needed.
                  </p>
            ...
            <div style={styles.quadGrid}>
              {[
                ...
                <div key={label} style={styles.quadCard}>
                  <span className="material-symbols-outlined" style={styles.quadIcon}>
                    {icon}
                  </span>
...
export default UserParkingInfoMobile;
